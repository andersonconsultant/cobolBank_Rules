...
# Nomes dos arquivos
EXEC="bin/sqlcommands"
MAIN_SRC="dev/sqlcommands.cob"

ALLOC_OBJ="bin/allocate.o"
ALLOC_SRC="dev/allocate.cob"

DISCSQL_OBJ="bin/disconnectsql.o"
DISCSQL_SRC="dev/disconnectsql.cob"
